...
**▶ СЛЕДУЮЩИЙ ШАГ:** дождаться расстановки приоритетов издателем и решения Рината по патронам на старте; первыми в работу — загрузка сейва при старте, аналитика с ключами, предел количества при продаже, возврат ассетов в пакет.
