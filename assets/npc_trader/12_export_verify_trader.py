"""Export the 3 trader FBX (mesh + 21-bone RootAnim) + round-trip verify.
Same checks as the elder (12_export_verify_elder.py):
...
Run: blender.exe -b --factory-startup --python 12_export_verify_trader.py
"""
import bpy, sys, os
...
NAMES = ['SK_Trader_Head', 'SK_Trader_Torso', 'SK_Trader_Legs']
