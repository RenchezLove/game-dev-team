"""Export 6 T2/T3 wearables FBX (mesh + 21-bone RootAnim) + round-trip verify.
Same checks as batch 1 (03_export_verify.py):
...
Run: blender.exe -b --factory-startup --python 06_export_verify_t2t3.py
"""
import bpy, sys, os
sys.path.insert(0, 'E:/game-dev-team/assets/armor_wearables')
import wcommon as W

NAMES = ['SK_Armor_T2_Head', 'SK_Armor_T2_Torso', 'SK_Armor_T2_Legs',
         'SK_Armor_T3_Head', 'SK_Armor_T3_Torso', 'SK_Armor_T3_Legs']
